...
public class SubscriptionOrderHandlerTest {
	...
	public void dummy() throws Exception {
		SubscriptionOrder event = new SubscriptionOrder("consumerKey", EventFlag.DEVELOPMENT, null, null, null, null, "partner", "applicationUuid", null, "eventToken", "http://marketplace.url", "http://samlIdp.url");
